  ...
  List<Map<String, dynamic>> mountains = [
    {
      ...
      "description":
          """Mount Sinai is renowned for its association with various religious traditions, particularly in Christianity, Judaism, and Islam. According to biblical accounts, it is believed to be the place where Moses received the Ten Commandments from God. The mountain stands at an elevation of approximately 2,285 meters (7,497 feet) and offers breathtaking panoramic views of the surrounding desert landscape.\nMany pilgrims and tourists undertake the climb to the summit to witness the sunrise or sunset, creating a spiritually and visually significant experience.""",
      "location":
          """ Mount Sinai is situated in the southern part of the Sinai Peninsula, within the region of South Sinai, Egypt. It is part of the larger Sinai Peninsula and is located near the town of St. Catherine, home to the famous St. Catherine's Monastery.""",
      "tips":
...
""",
    ...
    },
    {
      ...
      "descrip": "Eastern Desert, Egypt.",
      "description":
          "Jebel Shayib, also known as Jebel Shayib el Banat, is the highest peak in mainland Egypt, towering at 2,187 meters. Its name translates to 'Mountain of the Old Man' in Arabic, believed to come from the light-colored granite summit block that resembles an elderly man's head with white hair.\nThe rugged peak offers a majestic view of the surrounding areas. On a clear day, you can see the Red Sea, the Sinai Peninsula, and even the Hejaz ranges of Arabia. The Nile Valley tablelands are also visible on the other side. Jebel Shayib is part of the Red Sea Mountains and is considered one of the most challenging mountains to climb in Egypt. There are several routes to the summit, all of which require a good level of fitness and experience.",
      "location":
          "Jebel Shayib is situated in the Eastern Desert of Egypt, around 40 kilometers away from the Red Sea, located between the cities of Hurghada and Safaga.",
      "tips":
          " it's best to avoid the scorching summer heat. The ideal season for climbing is between October to April when the weather is cooler.",
      "latitude": 26.9797,
      "longitude": 33.4864
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: CustomCategory(items: mountains),
    );
  }
}
